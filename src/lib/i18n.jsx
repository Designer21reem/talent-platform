...
export const AR_DICT = {
  ...
  'Verify & Sign In': 'تأكيد وتسجيل الدخول',
  'Enter the code sent to': 'أدخل الرمز المُرسل إلى',
  'Verification code': 'رمز التحقق',
  'Could not send a verification code.': 'تعذّر إرسال رمز التحقق.',
  'Invalid or expired code.': 'الرمز غير صحيح أو منتهي الصلاحية.',
  'Could not reach the backend.': 'تعذّر الوصول إلى الخادم.',
  'How are we doing?': 'كيف كانت تجربتك؟',
  'Rate your experience with THE VALUE.': 'قيّم تجربتك مع THE VALUE.',
  'Would you recommend this website to others?': 'هل توصي بهذا الموقع للآخرين؟',
  'Yes': 'نعم',
  'No': 'لا',
  'stars': 'نجوم',
  'Submit Review': 'إرسال التقييم',
  'Thanks for the feedback!': 'شكراً على ملاحظاتك!',
  'It helps us keep improving THE VALUE.': 'هذا يساعدنا على تطوير THE VALUE باستمرار.',
  "Couldn't submit your review right now, but thanks for the feedback.":
    'تعذّر إرسال تقييمك الآن، لكن شكراً على ملاحظاتك.',
  ...
  // ── Assessment ────────────────────────────────────────────────
  'Personal Style': 'النمط الشخصي',
  'A short, optional questionnaire to help us understand how you naturally think and work.':
    'استبيان قصير واختياري يساعدنا على فهم طريقة تفكيرك وعملك الطبيعية.',
  'Answer honestly — there are no right or wrong answers. Your responses are used only to build your personal style profile and are never shared without your consent.':
    'أجب بصدق — لا توجد إجابات صحيحة أو خاطئة. تُستخدم إجاباتك فقط لبناء ملف نمطك الشخصي ولا تتم مشاركتها أبداً دون موافقتك.',
